<script>
  ...
  let navLinks = [
    ...
    {to: "/register", text: "Register", icon: "add"},
  ]
...
<main class="flex flex-row h-screen w-screen bg-slate-700 text-gray-200">
  <Router>
    <nav class="flex flex-col shrink mr-2 bg-slate-800">
      {#each navLinks as link}
        <Link class="p-2 hover:bg-slate-900 border-1 border-b border-slate-600" to={link.to}>
